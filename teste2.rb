...
#journa_list.min{|x,y| x.length <=> y.length}
#
##Handle contenant 5 caratere
#puts journa_list.count{|x| x.delete("@").length == 5}
#
##combien de handle contienne une majuscule
#def majuscule(items)
#    counter = 0
#    items.each do |handle|
...
#journa_list.sort_by(&:length)
#
##Quelle est la position dans l'array de la personne @epenser ?
#journa_list.index("@epenser")

# Sors-moi une répartition des handle par taille de ces derniers (nombre de handle avec 
# 1 caractère, nombre de handle avec 2 caractères, nombre de handle avec 3 caractères, etc)
